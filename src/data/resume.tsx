...
export const DATA = {
  ...
  summary:
    "At the end of 2023, I hold a bachelor's degree in Mathematics (2023) and am currently pursuing my MCA. My journey includes personal projects, competing in 1 hackathon, and an ongoing interest in learning DSA.",
  avatarUrl: "/me.jpg",
  skills: [
    "React",
    "Next.js",
